    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_sorteo_1', models.CharField(default=b'JU', max_length=2, choices=[(b'JU', b'En juego'), (b'EN', b'Entregado'), (b'AC', b'Acumulado')])),
                ...
                ('estado_sorteo_2', models.CharField(default=b'JU', max_length=2, choices=[(b'JU', b'En juego'), (b'EN', b'Entregado'), (b'AC', b'Acumulado')])),
                ...
                ('ganador_registro_compras', models.ManyToManyField(related_name=b'ganador_sorteo_compras', to='ruperton.Ganador')),
                ('ganador_sorteo_1', models.ManyToManyField(related_name=b'ganador_sorteo_1', to='ruperton.Ganador')),
                ('ganador_sorteo_2', models.ManyToManyField(related_name=b'ganador_sorteo_2', to='ruperton.Ganador')),
            ],
            options={
            },
            bases=(models.Model,),
